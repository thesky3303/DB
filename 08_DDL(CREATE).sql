 ...
 * * USER_constraints : 계정이 작성한 계약조건을 확인할 수 있는 딕셔너리 뷰
 * * USER _CONS_COLUMNS : 제약조건이 걸려있는 컬럼을 확인하는 딕셔너리 뷰
 * */
...
CREATE TABLE "MEMBER" (
	...
	MEMBER_SSN CHAR(14), -- '9912123-1234567'
...
-- ORA-01400: NULL을 ("KH_KWH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- RA-00001: 무결성 제약 조건(KH_KWH.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KWH.USER_ID_NAME_U)에 위배됩니다
-- 복합키로 지정된 컬럼값중 하나라도 다르면 위배되지 않음
--> 모든 컬럼의 값이 중복되면 위배된다!
...
-- 기본키 중복 오류!
-- ORA-00001: 무결성 제약 조건(KH_KWH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'you123@kh.or.kr');
-- 기본키 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_KWH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다


INSERT INTO USER_USED_PK
VALUES(2, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'you123@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES(2, 'USER01', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee123@kh.or.kr');


INSERT INTO USER_USED_PK2
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KWH.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_KWH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- USER,GRADE (부모테이블/참조테이블)에 10 이라는 GRADE_CODE 가 존재하므로 가능
...
-- USER,GRADE (부모테이블/참조테이블)에 30 이라는 GRADE_CODE 가 존재하므로 가능
...
-- Q ORA-02291: 무결성 제약조건(KH_KWH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 외래키 제약조건에 뒤배되어 오류 발생.
...
-- ORA-02292: 무결성 제약조건(KH_KWH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_KWH.GENDER_CHECK)이 위배되었습니다
